...
import Logo from "../public/opensea-white.svg";
...
export default function Footer() {
  ...
  return (
    <>
      <div className="banière-footer">
        <div className="Blockreact ">
          <a
            className="styles__StyledLink-sc-l6elh8-0 ekTmzq"
            href="https://a16z.com/"
          ...
          <a
            ...
            aria-label="Coinbase"
          >
            <svg className="BackedBy--logo" viewBox="0 0 112 25">
          ...
          <a
            ...
            rel="nofollow noopener noreferrer"
            target="_blank"
            aria-label="YCombinateur"
          >
            <svg
              className="YCombinatorLogoreact-sc-nnkjgo-0 ifWgdQ BackedBy--logo"
              viewBox="0 0 140 30"
            >
              <path
          ...
          <a
            ...
            rel="nofollow noopener noreferrer"
            target="_blank"
            aria-label="Laboratoires Dapper"
          >
            <svg className="BackedBy--logo" viewBox="0 0 87 25">
          ...
          <a
            ...
            rel="nofollow noopener noreferrer"
            target="_blank"
            aria-label="Timbre quantitatif"
          >
            <svg className="BackedBy--logo" viewBox="0 0 157 30">
          ...
          <a
            ...
            rel="nofollow noopener noreferrer"
            target="_blank"
            aria-label="Fonds des fondateurs"
          >
          ...
          <a
            ...
            rel="nofollow noopener noreferrer"
            target="_blank"
            aria-label="Capitale de la blockchain"
          >
      ...
      <div className="container-footer">
        <div className="footer-container">
          <div className="footer-row">
            <p className="title-footer">Rester dans la boucle</p>
            <p className="text-footer-title" style={{ width: "78%" }}>
              Rejoignez notre liste de diffusion pour rester au courant de nos
              dernières versions de fonctionnalités, des gouttes NFT et des
              trucs et astuces pour naviguer sur OpenSea.
            </p>
            <Paper
              component="form"
              sx={{
            ...
            >
              ...
              <InputBase
                ...
                inputProps={{ "aria-label": "dresse e-mail" }}
              />
          ...
          <div className="footer-row ">
            <p className="title-footer">Rejoignez la communauté</p>

            <div className="jYqxGr">
              <a
                ...
                aria-label="Twitter"
              >
                <div className="Blockreact__Block-sc-1xf18x6-0 Flexreact__Flex-sc-1twd32i-0 icons__DivContainer-sc-1dx2b3i-0 dBFmez jYqxGr eeUNRj">
                  <svg
                    className=""
                    fill="#FFFFFF"
              ...
              >
                <div className="Blockreact__Block-sc-1xf18x6-0 Flexreact__Flex-sc-1twd32i-0 icons__DivContainer-sc-1dx2b3i-0 dBFmez jYqxGr eeUNRj">
                  <i
                    ...
                    size="30"
                    value="mail"
                    className="Iconreact__Icon-sc-1gugx8q-0 fBUFyr material-icons-outlined"
                  >
                    <font style={{ verticalAlign: "inherit" }}>
                      <font style={{ verticalAlign: "inherit" }}>poster</font>
                    </font>
                  </i>
                </div>
              </a>
      ...
      <div className="footer-botom">
        {" "}
        <div style={{ width: "25%" }}>
          <Image src={Logo} alt="crypto" width="50" height="50" />
          <p className="paz">Pazuru</p>
          <p className="text-footer-title">
            Le premier et le plus grand marché numérique au monde pour les
            objets de collection cryptographiques et les jetons non fongibles
            (NFT). Achetez, vendez et découvrez des articles numériques
            exclusifs.{" "}
          </p>
        </div>
        <div className="conteneur-lien">
          <div className="colone-lien">
            <font className="title-colone">Marché</font>
            <a className="aLink">Tous les TVN</a>
            <a className="aLink"> Nouvelle</a>
            <a className="aLink">Art</a>
            <a className="aLink">Object de collection</a>
            <a className="aLink"> Noms de domaine</a>
            <a className="aLink">Musique</a>
            <a className="aLink">La photographie</a>
            <a className="aLink">Sport</a>
            <a className="aLink">Carte a colectionner</a>
          </div>
          <div className="colone-lien">
            {" "}
            <font className="title-colone">Mon compte</font>
            <a className="aLink">Profil</a>
            <a className="aLink"> Favoris</a>
            <a className="aLink">Mes collections</a>
            <a className="aLink">Reglage</a>
            <font className="title-colone" style={{ marginTop: 48 }}>
              Mon compte
            </font>
            <a className="aLink"> Classements</a>
            <a className="aLink">Activité</a>
          </div>
          <div className="colone-lien">
            {" "}
            <font className="title-colone">Ressource</font>
            <a className="aLink">centre</a>
            <a className="aLink"> status de la plateforme</a>
            <a className="aLink">les partenaire</a>
            <a className="aLink">Marché sans gaz</a>
            <a className="aLink"> Blog</a>
            <a className="aLink"> Document</a>
            <a className="aLink"> Bulletin</a>
          </div>
          <div className="colone-lien">
            {" "}
            <font className="title-colone">Societe</font>
            <a className="aLink">A propos TVN</a>
            <a className="aLink"> Carrière</a>
          </div>
        </div>
      </div>
    </>
